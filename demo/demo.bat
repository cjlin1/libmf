...
%train% -f 0 -l2 0.05 -k 100 -t 1 -p real_matrix.te.txt real_matrix.tr.txt rvmf_model.txt
...
:: In-memory training with holdout valudation
%train% -f 5 -l2 0.01 -k 64 -t 1 -p binary_matrix.te.txt binary_matrix.tr.txt bmf_model.txt
...
%train% -f 10 -l2 0.01 -k 32 -t 1 -p all_one_matrix.te.txt all_one_matrix.tr.txt ocmf_model.txt
